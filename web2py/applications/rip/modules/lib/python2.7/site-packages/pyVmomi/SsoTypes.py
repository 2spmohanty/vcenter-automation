...
AddVersion("vmodl.version.version0", "", "", 0, "")
...
CreateEnumType("sso.admin.RoleManagementService.Role", "SsoAdminRoleManagementServiceRole", "sso.version.version1", ["GuestUser", "RegularUser", "ConfigurationUser", "Administrator"])
